...
* prerequisite:
      BigQuery Account.
      Attached CSV files having related data,import into BigQuery and process the result set.
      Table and Relation:
...
### 2. Use Case:
          Client X would like to see the a reward perfomance weekly breakdown along with comparison of previous week.
